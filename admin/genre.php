...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="../plugins/loader/waitMe.css">
	...
	<title><?php echo AppName; ?> – Genres</title>
...
<body>
	...
	<div class="sidebar">
		...
		<ul class="sidebar__nav">
			...
			<li class="sidebar__nav-item">
				<a href="genre" class="sidebar__nav-link sidebar__nav-link--active"><i class="side_icon feather icon-layers"></i> <span>Genres</span></a>
			</li>
		...
		<div class="container-fluid">
			<div class="row">
              ...
              <?php require_once('../const/check_reply.php'); ?>
                  ...
                  ?>
                  <tr>
                    <td width="100"><div class="main__table-text"><?php echo $row[0]; ?></div></td>
                    ...
                    <a onclick="return confirm('Are you sure you want to delete?');" href="core/delete_genre?node=<?php echo $row[0]; ?>" class="delete_link">
                      Delete
                    </a></div>
									</td>
                  </tr>
  ...
  <div id="modal-add" class="zoom-anim-dialog mfp-hide modal">
    <h6 class="modal__title">Add Genre</h6>
    <form action="core/new_genre" method="POST" autocomplete="OFF" id="ifrm">
    <div class="row">
			<div class="col-12">
				<div class="form__group">
					<input name="genre" required type="text" class="form__input form_control txt-cap" placeholder="Enter Genre">
				</div>
			</div>
  ...
  <div id="modal-edit" class="zoom-anim-dialog mfp-hide modal">
    <h6 class="modal__title">Edit Genre</h6>
    <form action="core/edit_genre" method="POST" autocomplete="OFF" id="ifrm2">
    <div id="response">
