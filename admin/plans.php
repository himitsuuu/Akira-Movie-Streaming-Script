		...
		<div class="container-fluid">
			<div class="row">
              ...
              <?php require_once('../const/check_reply.php'); ?>
                  ...
                  ?>
                  <tr>
                    <td><div class="main__table-text"><?php echo $row[0]; ?></div></td>
                    <td><div class="main__table-text"><?php echo $row[1]; ?></div></td>
                    <td><div class="main__table-text"><?php echo $valid; ?></div></td>
                    <td><div class="main__table-text"><?php if (AppCurrency == "") {}else{ print AppCurrency;} echo number_format($row[3],2); if (AppCurrency == "") {print ' '.AppISO.'';}else{}?></div></td>
										<td><div class="main__table-text"><?php echo $row[5]; ?>p</div></td>
                    <td width="100">
