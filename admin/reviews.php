...
require_once('const/review_query.php');
?>
...
<head>
  ...
  <link rel="stylesheet" href="../plugins/datatable/css/jquery.dataTables.min.css">
	...
	<title><?php echo AppName; ?> – Reviews</title>
...
<body>
	...
	<div class="sidebar">
		...
		<ul class="sidebar__nav">
			...
			<li class="sidebar__nav-item">
				<a href="reviews" class="sidebar__nav-link sidebar__nav-link--active"><i class="side_icon feather icon-star"></i> <span>Reviews</span></a>
			</li>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-12">
                  ...
                  <li id="reviews" onclick="window.location.href=this.id">Last Created</li>
									<li id="reviews?&srt=1" onclick="window.location.href=this.id">First Created</li>
									<li id="reviews?&srt=2" onclick="window.location.href=this.id">Rating</li>
								</ul>
							</div>

							<form action="reviews" class="main__title-form">
                    ...
                    <div class="main__table-text" ><?php echo truncate_string ($row[3], 40, " ..."); ?></div>
									...
									<td>
										<div class="main__table-btns">
											...
											<a onclick="return confirm('Are yuo sure you want to delete?');" href="core/drop_review.php?node=<?php echo $row[0];?>&href=reviews" class="main__table-btn main__table-btn--delete">
